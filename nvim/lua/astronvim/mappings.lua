...
maps.n["<C-u>"] = { "<C-u>zz", desc = "Scroll up and center buffer" }
maps.n["<C-d>"] = { "<C-d>zz", desc = "Scroll down and center buffer" }
...
if is_available "neo-tree.nvim" then
  ...
  maps.n["<leader>E"] = { "<cmd>Neotree position=current<cr>", desc = "Toggle Full Explorer" }
  maps.n["<leader>o"] = {
    function()
