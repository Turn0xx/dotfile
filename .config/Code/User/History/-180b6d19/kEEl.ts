...
import { clientBuilder } from '../../../../src/pocket-ticket/client/identity/test.concurrent/builders/client.builder';
import { InMemoryClientRepository } from '../../../../src/pocket-ticket/client/identity/test.concurrent/client.in-memory';
import { FakeEmailSender } from '../../../../src/pocket-ticket/notification-services/emails/test.concurrent/email-sender.fake';
import { EmailValidationService } from '../../../../src/pocket-ticket/notification-services/emails/application/email-validation.service';
import { InMemoryTokensRepository } from '../../../../src/pocket-ticket/client/identity/test.concurrent/tokens.in-memory';


import { test.concurrent , describe , afterAll , beforeAll , beforeEach , afterEach } from 'vitest';
...
describe('Basic Feature : Registration', async () => {
  ...
  describe('Individuals Scenarios', () => {
    describe('Scenario: Client registers for an account', () => {
      test.concurrent('Alice wants to register as an individual', async () => {
    ...
    describe('Scenario: Client registers for an account with an existing unique field', () => {
      test.concurrent('Alice wants to register as an individual with existing email', async () => {
        fixture.givenNowIs(new Date('2023-01-01T10:30:00.000Z'));
      ...
      test.concurrent('Alice wants to register as an individual with existing phone number', async () => {
        fixture.givenNowIs(new Date('2023-01-01T10:30:00.000Z'));
        await fixture.givenExistingIndividuals([
          IndividualClient.fromJson(
            clientBuild
  ...
  describe('Companies Scenarios', () => {
    describe('Scenario: Client registers for an account', () => {
      test.concurrent('Alice wants to register as a company', async () => {
        fixture.givenNowIs(new Date('2023-01-01T10:30:00.000Z'));
        await fixture.whenAliceRegisters(
    ...
    describe('Scenario: Client registers for an account with an existing unique field', () => {
      test.concurrent('Alice wants to register as a company with existing email', async () => {
        fixture.givenNowIs(new Date('2023-01-01T10:30:00.000Z'));
        await fixture.givenExistingIndividuals([
          IndividualClient.fromJson(
            clientBuild
      ...
      test.concurrent('Alice wants to register as a company with existing phone number', async () => {
        fixture.givenNowIs(new Date('2023-01-01T10:30:00.000Z'));
        await fixture.givenExistingIndividuals([
          IndividualClient.fromJson(
            clientBuild
