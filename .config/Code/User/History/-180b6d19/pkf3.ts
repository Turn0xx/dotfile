...
import { RegistrationCommand, registrationCommandBuilder } from './../../../src/pocket-ticket/client/authentification/application/registration.command';
...
import { EmailAlreadyExistsError, DuplicateFieldError } from '../../../src/pocket-ticket/client/authentification/errors/duplicateField.error';
...
const createFixture = () => {
  ...
  let emailValidator = new EmailValidationService(clientRepository , emailSender);
