...
import { test , describe , beforeEach, bench } from 'vitest';

describe.concurrent('Basic Feature : Registration', async () => {
  let fixture: Fixture;
  ...
  describe.concurrent('Validation tests : ', () => {
    ...
    test('Alice wants to register as an individual with invalid email', async () => {
      fixture.givenNowIs(new Date('2023-01-01T10:30:00.000Z'));
      await fixture.whenAliceRegisters(
        registrationCommandBuild
          .toIndividualClient('Alice', 'Doe')
      ...
      fixture.thenErrorShouldBe(Error);
    });

    test('Alice wants to register as an individual with invalid phone number', async () => {
      fixture.givenNowIs(new Date('2023-01-01T10:30:00.000Z'));
      await fixture.whenAliceRegisters(
        registrationCommandBuild
          .toIndividualClient('Alice', 'Doe')
          .withPhoneNumber('0636518875')
          .build(),
      );
