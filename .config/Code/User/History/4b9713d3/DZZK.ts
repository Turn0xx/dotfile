import { ValidateTokenUseCase } from './../../../src/pocket-ticket/client/authentification/application/usecases/validate-token.usecase';
import {
  RegistrationCommand,
...
describe('Basic Feature : Account Validation', async () => {
  ...
  describe('Scenario: Client validates his account', () => {
    ...
    it('When User Validates his account with a invalid token', async () => {
      ...
      await fixture.whenUserShouldValidateHisAccountWith(command.id, 'invalid');
