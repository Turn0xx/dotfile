...
export const registrationCommandBuilder = ({
  ...
  return {
    toIndividualClient: (firstName: string, lastName: string) =>
      individualRegistrationCommandBuilder({ ...props, firstName, lastName }),
    ...
    withEmail: (email: string) => registrationCommandBuilder({ ...props, email }),
    withPassword: (password: string) => registrationCommandBuilder({ ...props, password }),
    withPhoneNumber: (phoneNumber: string) => registrationCommandBuilder({ ...props, phoneNumber }),
    withType: (type: string) => registrationCommandBuilder({ ...props, type }),
...
export const individualRegistrationCommandBuilder = ({
  ...
  type = 'individual',
    ...
    return {
      withId: (id: number) => individualRegistrationCommandBuilder({ ...props, id }),
      withEmail: (email: string) => individualRegistrationCommandBuilder({ ...props, email }),
      withPassword: (password: string) => individualRegistrationCommandBuilder({ ...props, password }),
      withPhoneNumber: (phoneNumber: string) => individualRegistrationCommandBuilder({ ...props, phoneNumber }),
      withLastName: (lastName: string) => individualRegistrationCommandBuilder({ ...props, lastName }),
      withFirstName: (firstName: string) => individualRegistrationCommandBuilder({ ...props, firstName }),
      withType: (type: string) => individualRegistrationCommandBuilder({ ...props, type }),
