...
import { RegistrationDto } from '../../framework/dto/registration.dto';
...
export const parseRegistrationCommand = (data: RegistrationDto): RegistrationCommand => {
  ...
  const command :RegistrationCommand = data;
...
> = {}) => {
  ...
  return {
    ...
    withId: (id: string) => registrationCommandBuilder({ ...props, id }),
...
export const companyRegistrationCommandBuilder = ({
  ...
  return {
    withId: (id: string) => companyRegistrationCommandBuilder({ ...props, id }),
    withEmail: (email: string) =>
