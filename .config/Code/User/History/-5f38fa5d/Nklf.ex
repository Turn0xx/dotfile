defmodule TimeManagerWeb.Account.Infrastructure.UserController do
  use TimeManagerWeb, :controller

  alias TimeManager.{Accounts.User, Accounts.Application.ManageUserService, Infrastructure.UserPresenter}
