...
export const clientBuilder = ({
  ...
  return {
    toIndividualClient: (firstName: string, lastName: string) => individualClientBuilder({ ...props, firstName, lastName }),
...
export const individualClientBuilder = ({
  ...
  return {
    ...
    withPassword: (password: string) => individualClientBuilder({ ...props, password }),
    withPhoneNumber: (phoneNumber: string) => individualClientBuilder({ ...props, phoneNumber }),
    withLastName: (lastName: string) => individualClientBuilder({ ...props, lastName }),
    withFirstName: (firstName: string) => individualClientBuilder({ ...props, firstName }),
    withCreatedAt: (createdAt: Date) => individualClientBuilder({ ...props, createdAt }),
