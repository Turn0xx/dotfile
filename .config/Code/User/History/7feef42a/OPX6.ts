...
export class TextAreaSetting {
    ...
    console.log("New colors: ", changes);
    ...
    added.forEach((color) => this.colorManager.addColor(Color.from(color)));
    removed.forEach((color) => this.colorManager.removeColor(Color.from(color)));
