...
import { IndividualClient, IndividualClientJson } from '../../domain/individual-client';
  ...
  async handle(command: RegistrationCommand) {
    ...
    try {
      await this.clientRepository.save(
        command.type === 'individual' ? IndividualClient.fromJson(client as IndividualClientJson) : CompanyClient.fromJson(client),
      );
