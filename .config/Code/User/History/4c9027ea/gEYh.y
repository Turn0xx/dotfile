...
*/
    ...
    insertSymbol("wertyui", INTEGER); //0
    insertSymbol("b", INTEGER); // 4
    insertSymbol("d", INTEGER); // 8
    newScope();
    //test find symbol
    printf("Find a : %d should be -1\n", findSymbolGlobal("a")); // should be -1
    printf("Find d : %d should be 8\n", findSymbolGlobal("d")); // should be 8

    insertSymbol("c", INTEGER); // 12
    insertSymbol("a", INTEGER); // 16
    printf("Find a : %d should be 0\n", findSymbolGlobal("a")); // should be 0
    printf("Find c : %d should be 4\n", findSymbolGlobal("c")); // should be 4

    popScope();
    printf("Find a : %d should be -1\n", findSymbolGlobal("a")); // should be -1
    printf("Find c : %d shoud be -1\n", findSymbolGlobal("c")); // should be -1

    newScope();
    insertSymbol("b", INTEGER); // 20
    newScope();
    
    insertSymbol("d", INTEGER); // 24

    printf("Find a : %d should be -1\n", findSymbolGlobal("a")); // should be -1
    printf("Find b : %d should be 0\n", findSymbolGlobal("b")); // should be 0
    printf("Find c : %d should be -1\n", findSymbolGlobal("c")); // should be -1
    printf("Find d : %d should be 4\n", findSymbolGlobal("d")); // should be 4
    printf("Find wertyui : %d should be 0\n", findSymbolGlobal("d")); // should be 0
