...
*/
    ...
    printf("Find a : %d\n should be 0", findSymbolGlobal("a")); // should be 0
    printf("Find c : %d\n should be 4", findSymbolGlobal("c")); // should be 4

    popScope();
    printf("Find a : %d\n should be -1", findSymbolGlobal("a")); // should be -1
    printf("Find c : %d\n shoud be -1", findSymbolGlobal("c")); // should be -1
    ...
    printf("Find a : %d\n should be -1", findSymbolGlobal("a")); // should be -1
    printf("Find b : %d\n should be 0", findSymbolGlobal("b")); // should be 0
    printf("Find c : %d\n should be -1", findSymbolGlobal("c")); // should be -1
    printf("Find d : %d\n should be 4", findSymbolGlobal("d")); // should be 4
    printf("Find wertyui : %d\n should be 0", findSymbolGlobal("d")); // should be 0
