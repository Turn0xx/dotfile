import { ClientDataModel, ClientSchema } from './../../../infrastructure/client.schema';
...
export class IndividualClient extends Client {
  ...
  fromJson(json: IndividualClientJson): IndividualClient {
  ...
  fromDataModel(dataModel: ClientSchema): IndividualClient {
    return new IndividualClient(
      dataModel.id,
