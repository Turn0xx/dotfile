...
describe('ClientTypeormRepository', () => {
  ...
  afterEach(async () => {
    // await datasource.query('DELETE FROM client_schema');
  });
  ...
  it('should be defined', async () => {
    ...
    console.log('typeormRepository', typeormRepository);
  });


  it('should save a client as individual', async () => {
    const clientToSave = IndividualClient.fromJson(clientStub.build());
    await clientRepository.save(clientToSave);
    ...
    expect(client).toEqual(clientToSave.toDataModel());
  });
