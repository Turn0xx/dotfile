...
describe('ClientTypeormRepository', () => {
  ...
  it('should save a client as individual', async () => {
    const clientToSave = IndividualClient.fromJsonToDataModel(clientStub.toIndividualClient('Alice' , 'Doe').build());
    const savedClient = await clientRepository.save(clientToSave);
