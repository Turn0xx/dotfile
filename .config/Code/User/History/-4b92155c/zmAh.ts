...
//   let organizerStub = organizerBuilder().withCreatedAt(new Date());
  ...
  clientRepository = testModule.get<ClientRepository>(PROVIDERS.CLIENT_REPOSITORY);
  typeormRepository = testModule.get<Repository<ClientSchema>>('TYPEORM_CLIENT_REPOSITORY');
