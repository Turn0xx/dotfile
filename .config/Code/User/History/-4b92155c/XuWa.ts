...
import { ClientRepository } from '../../../src/pocket-ticket/client/authentification/application/repositories/client.repository';
...
describe('ClientTypeormRepository', () => {
  ...
  it('save method should update existing client', async () => {
    ...
    const clientToUpdate = IndividualClient.fromJson(clientStub.toIndividualClient('Alice' , 'Kor').withId(1).build()).toDataModel();
