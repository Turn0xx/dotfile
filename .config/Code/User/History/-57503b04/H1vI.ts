...
export class Organizer {
  ...
  static fromJson(json: OrganizerJson): Organizer {
    return new Organizer(
      ...
      Password.fromValue(json.password , passwordValidator),
      json.username,
      Address.fromValue(json.organizationAddress , addressValidator),
      PhoneNumber.fromValue(json.phoneNumber , phoneValidator),
      json.createdAt,
      json.events,
    );
  }
  ...
  static fromDataModel(dataModel: OrganizerSchema): Organizer {
    return new Organizer(
      ...
      Email.fromValue(dataModel.email , emailValidator),
      Password.fromValue(dataModel.password , passwordValidator),
      dataModel.username,
      Address.fromValue(dataModel.organizationAddress , addressValidator),
      PhoneNumber.fromValue(dataModel.phoneNumber , phoneValidator),
      dataModel.createdAt,
