...
import { OrganizerSchema } from 'src/pocket-ticket/client/authentification/infrastructure/organizer.schema';
import { Test, TestingModule } from '@nestjs/testing';
import { OrganizerRepository } from 'src/pocket-ticket/client/authentification/application/organizer.repository';
import { OrganizerTypeOrmRepository } from 'src/pocket-ticket/client/authentification/infrastructure/organizer.typeorm';
import { DataSource, Repository } from 'typeorm';
import { organizerBuilder } from 'src/pocket-ticket/client/authentification/test/organizer.builder';
import { Organizer } from 'src/pocket-ticket/client/authentification/domain/organizer';
import { BasicInformationSchema } from 'src/pocket-ticket/client/authentification/infrastructure/basic-information.schema--';
import { EventSchema } from 'src/pocket-ticket/client/authentification/infrastructure/event.schema--';
import { basicInformationBuilder } from 'src/pocket-ticket//client/authentification/test/builders/basic-information.command.builder';
import { EventBasicInformations } from 'src/pocket-ticket/client/authentification/domain/basic-information--';
