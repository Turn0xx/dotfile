...
export class IdentityController {
  constructor(
    ...
    private readonly forgotPasswordService: ForgotPasswordService, @Inject(PROVIDERS.CLIENT_REPOSITORY) private readonly clientRepository: ClientRepository,
  ...
  async validateMe(@Request() req, @Query('token' , new ZodPipe({
    ...
    try {
      ...
      if (error.message === 'Invalid token') {
        ...
        return new TokenExpiredException() = PasswordService: ForgotPasswordService,
      }
