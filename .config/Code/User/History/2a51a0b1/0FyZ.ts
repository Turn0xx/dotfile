...
import { InMemoryAggregateOrganizerRepository } from 'src/pocket-ticket/client/test/aggregate-organizer.in-memory';
...
const createFixture = () => {
  ...
  const aggregateOrganizerRepository = new InMemoryAggregateOrganizerRepository(
    organizerRepository,
