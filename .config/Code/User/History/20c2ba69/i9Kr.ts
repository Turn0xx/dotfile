import { RegistrationCommand, UnionSchema } from './../../application/commands/registration.command';
import {
  Body,
  Controller,
  Inject,
...
export class RegistrationController {
  ...
  @Post('')
  async register(@Body(new ZodValidationPipe(UnionSchema)) command: RegistrationDto) {
    try {
