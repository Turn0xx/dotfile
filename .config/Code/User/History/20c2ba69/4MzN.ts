...
import { RegistrationCompanyDto, RegistrationIndividualDto } from '../dto/registration.dto';
...
export class RegistrationController {
  ...
  @ApiBody({ type: [RegistrationIndividualDto, RegistrationCompanyDto] })
  @Public()
  @HttpCode(HttpStatus.CREATED)
  @Post('')
  async register(@Body() command: RegistrationIndividualDto | RegistrationCompanyDto) {
    try {
