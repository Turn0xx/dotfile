...
import { ObservableAction } from "src/plugin/building-blocks/observability/subject";
...
export class ObsidianShortCuts implements ShortCuts , Observer {
	...
	update<T extends ObservableAction>(actionType: ActionType, colorName: string): void {
		if (actionType === "add") {
