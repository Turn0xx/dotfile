...
import { BasicInformation, BasicInformationsJSON } from "./basic-information"
...
export class Event {
    ...
    toDataModel(): EventSchema {
        ...
        event.basicInformation = BasicInformation.ofJson(this.basicInformation as unknown as BasicInformationsJSON);
