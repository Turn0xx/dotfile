...
export class Event {
  private constructor(
    ...
    static fromDataModel(dataModel: EventSchema): Event {
        return new Event(
            dataModel.id,
            EventBasicInformations.fromDataModel(dataModel.basicInformation).toJson(),
    ...
    toDataModel(): EventSchema {
        ...
        event.basicInformation = EventBasicInformations.fromJson(this.basicInformations).toDataModel();
        return event;
    }
